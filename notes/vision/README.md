...
| API | Scope |
| --- | --- |
| [RecognizeDocumentsRequest](./recognize-documents-request.md) | macOS 26 structured document recognition |
| [DetectHorizonRequest](./detect-horizon-request.md) | Horizon-leveling evidence for natural-image skew |
